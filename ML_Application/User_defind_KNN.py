...
def MarvellousNeighbor():
    ...
    print("Size of Actual data ser %d"%(i+1))
    ...
    for i in range(len(data_train)):
        print("ID:%d,Labal %s,Feature: %s" % (i, data_train[i], target_train[i]))
    ...
    for i in range(len(data_test)):
        print("ID:%d,Labal %s,Feature: %s" % (i,data_test[i],target_test[i]))
    print("Size of Test data set %d"%(i+1))
    print(border)
